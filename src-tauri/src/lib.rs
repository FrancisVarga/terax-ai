...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            pty::pty_close_all,
            modules::rmux::rmux_session_new,
            modules::rmux::rmux_session_list,
            modules::rmux::rmux_session_rename,
            modules::rmux::rmux_session_kill,
            modules::rmux::rmux_window_new,
            modules::rmux::rmux_window_split,
