...
import type { RightSidebarViewId } from "./types";

export const RIGHT_SIDEBAR_RAIL_HEIGHT = 36;

type RailItem = {
  id: RightSidebarViewId;
  label: string;
...
export function RightSidebarRail({ activeView, onSelectView }: Props) {
  ...
  return (
    <div
      style={{ height: RIGHT_SIDEBAR_RAIL_HEIGHT }}
